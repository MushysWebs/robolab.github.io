/****************** YOUR NAME: Grady Spurrill, 000715470
...
function changeDuration() {
    ...
    let newDurationText = prompt("Please enter a new duration: ");
    newDurationText = Number(newDurationText);
    durationTextSpan.innerHTML = newDurationText;
...
newDurationButton.addEventListener("click", changeDuration);